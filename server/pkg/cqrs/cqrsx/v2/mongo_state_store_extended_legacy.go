// mongo_state_store_extended.go - MongoDB 상태 저장소 확장 기능
package cqrsx
...
// 				"totalStorage":    bson.M{"$sum": "$size"},
// 				"avgSize":         bson.M{"$avg": "$size"},
// 				"maxSize":         bson.M{"$max": "$size"},
// 				"minSize":         bson.M{"$min": "$size"},
// 				"oldestTimestamp": bson.M{"$min": "$timestamp"},
// 				"newestTimestamp": bson.M{"$max": "$timestamp"},
// 			},
// 		},
// 	}
...
// 				{"timestamp", -1},
// 			},
// 			Options: options.Index().SetName("aggregateType_timestamp"),
// 		},
// 		{
// 			Keys: bson.D{
// 				{"timestamp", -1},
...
// 				{"size", -1},
// 			},
// 			Options: options.Index().SetName("size_desc"),
// 		},
// 		{
// 			Keys: bson.D{
// 				{"aggregateId", 1},
// 				{"timestamp", 1},
// 			},
// 			Options: options.Index().SetName("aggregateId_timestamp"),
// 		},
// 		{
// 			Keys: bson.D{
// 				{"compressed", 1},
// 				{"encrypted", 1},
// 			},
// 			Options: options.Index().SetName("compression_encryption_flags"),
// 		},
// 	}
