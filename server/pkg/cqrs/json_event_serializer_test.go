...
// 	event := NewBaseEventMessageWithConfig("UserCreated", eventData)
...
// 	originalEvent := NewBaseEventMessageWithConfig("UserCreated", originalEventData)
...
// 	event := NewBaseEventMessageWithConfig("UnregisteredEvent", eventData)
// 	event.SetEventID("event-123")
// 	event.SetTimestamp(time.Now())
