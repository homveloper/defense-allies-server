...
// 	event := NewBaseEventMessageWithConfig("TestEvent", "test data")
...
// 	aggregate := NewBaseAggregate("test-id", "TestAggregate")
// 	events := []EventMessage{
// 		NewBaseEventMessageWithConfig("Event1", "data1"),
// 		NewBaseEventMessageWithConfig("Event2", "data2"),
// 		NewBaseEventMessageWithConfig("Event3", "data3"),
// 	}
